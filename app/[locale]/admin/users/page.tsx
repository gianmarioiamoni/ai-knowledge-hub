...
export default async function AdminUsersRoute({
  ...
  const labels = {
    ...
    demoData: {
      ...
      statusActive: t("demoData.statusActive"),
      statusNotSeeded: t("demoData.statusNotSeeded"),
      documents: t("demoData.documents"),
      conversations: t("demoData.conversations"),
      procedures: t("demoData.procedures"),
      chunks: t("demoData.chunks"),
      messages: t("demoData.messages"),
      seedButton: t("demoData.seedButton"),
      resetButton: t("demoData.resetButton"),
      resetTitle: t("demoData.resetTitle"),
      resetDescription: t("demoData.resetDescription"),
      resetConfirm: t("demoData.resetConfirm"),
      cancel: t("demoData.cancel"),
      seeding: t("demoData.seeding"),
      resetting: t("demoData.resetting"),
      seedSuccess: t("demoData.seedSuccess"),
      seedError: t("demoData.seedError"),
      resetSuccess: t("demoData.resetSuccess"),
      resetError: t("demoData.resetError"),
    },
  };
